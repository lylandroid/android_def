...
public class TokenDemo extends TestCase {
	
	private static final Logger log = Logger.getLogger(TokenDemo.class);
...
//		String md5 = DigestUtils.md5Hex(signData);
		String md5 = Md5Utils.encode(signData);
		jsonData.put("sign", md5);
...
//		 org.apache.http.impl.client.HttpClients
		...
		try {
			...
			jsonStringEntity.setContentEncoding(new BasicHeader(HTTP.CONTENT_TYPE, "application/json"));
