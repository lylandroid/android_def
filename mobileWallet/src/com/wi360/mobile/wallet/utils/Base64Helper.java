...
public abstract class Base64Helper {
	 ...
	 *  
	  * @param s
	  * @return  
	  * @version: 2013-12-4 下午4:59:39
	  * @See:
	 */
	public static char[] encodeToChar(String s) {
		return encodeToChar(s.getBytes(Charset.forName("UTF-8")), false);
	}
	...
	public static byte[] encodeToByte(String s) {
		return encodeToByte(s.getBytes(Charset.forName("UTF-8")), false);
	}
	...
	public static String encodeToString(String s) {
		return new String(encodeToChar(s.getBytes(Charset.forName("UTF-8")), false));
	}

	public static String encodeToString(String s, Charset charset) {
		return new String(encodeToChar(s.getBytes(charset), false));
	}
	...
	public static String decodeToString(String s, Charset charset) {
